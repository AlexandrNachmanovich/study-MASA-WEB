...
console.log(orderedByBirthdate);

// 4. How many years did all the inventors live? Sum up all their lived years together
...
const orderedByYearsLived = inventors.sort(
...
// 7. Count the instances of each of these
